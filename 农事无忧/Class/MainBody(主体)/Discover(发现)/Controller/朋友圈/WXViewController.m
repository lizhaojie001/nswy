...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    return section==0? [UIScreen mainScreen].bounds.size.height*0.4:0;
}
- (UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (section ==0) {
       
        View* view =  [[NSBundle mainBundle] loadNibNamed:@"View" owner:nil options:nil][0] ;
        [view.avtarButton addTarget:self action:@selector(click) forControlEvents:UIControlEventTouchUpInside];
