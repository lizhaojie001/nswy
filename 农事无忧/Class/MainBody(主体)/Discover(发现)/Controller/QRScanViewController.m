...
@import AVFoundation;
#import "NXHImagePickController.h"
...
- (void)pickAction:(UIBarButtonItem *)sender {
	NXHImagePickController *imagePickerController = [[NXHImagePickController alloc] init];
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem * item = [[UIBarButtonItem alloc]initWithTitle:@"从相册获取"style:UIBarButtonItemStylePlain target:self action:@selector(pickAction:)];
